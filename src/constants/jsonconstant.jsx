...
//     { color:'#FDEBF9',subject:'Total Employe',count:'24'}]
...
//     {topic:'IT Department need two UX/UI Designer position',time:'Yesterday, 09:15 AM'},
...
const announcementdata=[{topic:'Meeting AWS Department',time:'5 Minutes ago'},
    {topic:'Meeting HR Department',time:'Yesterday, 12:30 PM'},
    {topic:'Hiring UX/UI Designer',time:'Yesterday, 09:15 AM'},
    {topic:'Outing schedule for every departement',time:'5 Minutes ago'},
    {topic:'Meeting HR Department',time:'Yesterday, 12:30 PM'},
